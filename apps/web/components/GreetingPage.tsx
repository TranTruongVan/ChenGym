...
export default function GreetingPage({}: Props) {
  return (
    <div className="flex w-full flex-col">
      <section className="relative flex min-h-screen md:bg-none bg-[url('/header-bg.jpg')] bg-center bg-no-repeat bg-cover">
        <video
          src="/bg-video.mp4"
          className="absolute h-full w-full object-fill hidden md:inline"
          autoPlay
          loop
          muted
        />
      ...
      <section className="w-full bg-primary bg-contain bg-right bg-no-repeat py-12 md:bg-[url('/trainer-bg.jpg')] md:py-24">
        <div className="container">
          <div className="flex w-full flex-col items-center gap-4 md:gap-8 md:w-1/2 md:items-start">
            ...
            <button className="btn-black-1 btn w-48 text-white-1 md:btn-lg md:w-72">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="flex w-full flex-col gap-8 bg-black-2 py-8 md:gap-16 md:py-24">
        <div className="container md:grid md:grid-cols-12 md:gap-8">
          <div className="flex w-full flex-col items-center justify-center gap-4 md:col-span-6 md:items-start md:gap-8">
            ...
            <button className="btn-primary btn w-48 text-white-1 md:btn-lg md:w-72">
              Take a tour
            </button>
          </div>
